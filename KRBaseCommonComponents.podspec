#
#  Be sure to run `pod spec lint KRBaseCommonComponents.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  基础通用组件,放工具类,全局配置,类别等文件.
                   DESC

  spec.homepage     = "https://github.com/AaronDai23/KRBaseCommonComponents.git"
  ...
  spec.license      = "MIT (KRBaseCommonComponents)"
  ...
  spec.source       = { :git => "https://github.com/AaronDai23/KRBaseCommonComponents.git", :tag => "#{spec.version}" }
